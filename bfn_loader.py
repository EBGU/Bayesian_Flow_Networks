...
if __name__ == '__main__':
    ...
    dataset = BFNDataset("/drug/OxfordFlowers/train",[64,64],sigma1=0.01)
    for i in range(0,2000,20):
        print(i)
        img,noisy_img,t,gamma = dataset.__getitem__(0,i/2000)
        img = (img + 1)/2
